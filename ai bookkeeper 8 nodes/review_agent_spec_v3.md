...
- ✅ 读取 profile.md, rules.md, observations.md, COA.csv, tax_reference.md, 输出报告, Transaction Log
...
- ❌ 修改 workflow 逻辑
- ❌ 直接修改 profile.md（profile 变更通过 Coordinator Agent 处理；审核 Agent 如果在对话中捕获到 profile 变更信号，应建议 accountant 在下次处理时更新）
